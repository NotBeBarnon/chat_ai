...
HTTP_BASE_URL = PROJECT_CONFIG.get("http_base_url", "/api/chat_ai")
...
DATABASE_CONFIG = {
    "connections": {
        "master": {
            ...
            "credentials": {
                "host": os.getenv("MASTER_DATABASE_HOST", PROJECT_CONFIG["database"]["master"]["host"]),  # FS_DATABASE_HOST 数据库名称环境变量根据需求修改
